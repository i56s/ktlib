...
public final class SwitchButton extends View {
     ...
     */
    protected final float mAspectRatio = 0.5f;
    /**
     * (0,1]
     */
     ...
     * 开启状态背景色
     */
    protected int mAccentColor = 0xFF32D8D2;
    /**
     * 开启状态按钮描边色
     */
    protected int mPrimaryDarkColor = 0xFF2CBCB7;
    /**
     * 关闭状态描边色
     */
     ...
     * 按钮正常的背景色（关闭状态下）
     */
    protected int mBgColor = 0xFFDFDFDF;
    /**
     * 按钮禁用的背景色
     */
    protected int mBgEnabledColor = 0xFFBFBFBF;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (isEnabled()) {
            ...
            mPaint.setColor(mBgEnabledColor);
        }
        canvas.drawPath(mBackgroundPath, mPaint);
        canvas.restore();
