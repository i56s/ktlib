...
public class MaterialWaveView extends View implements BaseMaterialView {
    ...
    public void onSlide( float fraction) {
        setHeadHeight((int) (SizeUtils.dp2px(DefaulHeadHeight) * SizeUtils.limitValue(1, fraction)));
        setWaveHeight((int) (SizeUtils.dp2px(DefaulWaveHeight) * Math.max(0, fraction - 1)));
        invalidate();
    }

    @Override
    public void onRefreshing() {
        setHeadHeight((int) (SizeUtils.dp2px(DefaulHeadHeight)));
